...
function CTG() {
    var InputConverter = document.getElementById("InputConverter");
    var tal = Number(InputConverter.value);
    var FNumber = convertToGram(tal);
...
function CTO() {
    var InputConverter = document.getElementById("InputConverter");
    var tal = Number(InputConverter.value);
    var FNumber = convertToOunces(tal);
    document.getElementById("Output").innerHTML = FNumber;
}
var toGramButton = document.getElementById("ConvertToGram");
toGramButton.addEventListener("click", CTG);
var toOuncesButton = document.getElementById("ConvertToOunces");
